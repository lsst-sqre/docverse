...
- Model fields now declare realistic OpenAPI example values: HATEOAS `*_url` fields show full example URLs and public-ID fields show genuine Crockford Base32 identifiers, drawn from shared constants in `docverse.models._examples`.
