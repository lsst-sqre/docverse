...
Mirrors :mod:`docverse_server.services.lifecycle_finalisation` so per-org
...
from docverse.models import GitRefAuditRunStatus
...
async def maybe_finalise_git_ref_audit_run(
    *,
    ...
    :func:`docverse_server.services.lifecycle_finalisation
