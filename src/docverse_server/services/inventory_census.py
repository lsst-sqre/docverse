...
from docverse_server.domain.inventory_census import InventoryCensus
...
class InventoryCensusService:
    ...
    :class:`docverse_server.services.keeper_sync_run.KeeperSyncRunService`):
    the store owns the grouped-aggregate SQL and this service is the
