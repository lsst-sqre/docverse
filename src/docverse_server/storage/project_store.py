...
class ProjectStore:
    ...
    async def list_by_github_repo(
        ...
        *,
        ...
        Used by :class:`docverse_server.services.ref_deleted_processor
    ...
    async def rename_repo_by_repo_id(
        ...
        *,
        ...
        Used by :class:`docverse_server.services.dashboard_templates
    ...
    async def transfer_repo_by_repo_id(
        ...
        *,
        ...
        Mirrors :meth:`docverse_server.storage.dashboard_templates.github
    ...
    async def update_github_metadata(
        ...
        *,
        ...
        Used by :func:`docverse_server.worker.functions.project_github_resolve`
