...
class KeeperSyncState(BaseModel):
    ...
    Project-resource rows
        ...
        consumed by
        :func:`docverse_server.services.keeper_sync.scheduler.should_poll_main_for_project`
...
class KeeperSyncStateStore:
    ...
    async def list_project_resources_for_org(
        ...
        *,
        ...
        :class:`docverse_server.storage.pagination.KeeperSyncProjectStateIdCursor`
        ...
        """
        from docverse_server.storage.pagination import (  # noqa: PLC0415
            KeeperSyncProjectStateIdCursor,
        )
    ...
    async def list_tombstones_for_org(
        ...
        *,
        ...
        Pagination uses
        :class:`docverse_server.storage.pagination.KeeperSyncStateDateTombstonedCursor`
