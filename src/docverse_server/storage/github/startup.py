...
class GitHubAppValidationState(Protocol):
    ...
    :class:`docverse_server.dependencies.context.ContextDependency` and
    :class:`docverse_server.worker.main.WorkerFactoryBuilder` each implement
...
async def validate_github_app(
    *,
    ...
    :meth:`docverse_server.factory.Factory._require_github_app_config` already
