...
from docverse.models import JobKind, LifecycleEvalRunStatus
from docverse_server.domain.lifecycle_eval_run import LifecycleEvalRun
...
async def lifecycle_eval_dispatcher(ctx: dict[str, Any]) -> str:
    ...
    logger = structlog.get_logger(
        "docverse_server.worker.lifecycle_eval_dispatcher"
    )
