...
reached arq, and arq then lost the job — PRD #538). A kind may add a
fourth, kind-specific pass of its own through the ``extra_sweep`` hook
— ``build_processing`` uses it to retire builds its queue jobs left
behind (PRD #577).
